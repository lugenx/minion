...
sources:
  ...
  # It visits the URL, finds every href containing "/events/", and scrapes them all!
...
```yaml
ai_instructions:
  - "Must be an in-person event in New York."
  - "Looking for tech events or any nerdy events."
  - "Must occur on Tuesday/Wednesday after 17:00."
```
...
```yaml
webhook:
  # Example: A private self-hosted ntfy server
  url: "https://ntfy.mydomain.com/alerts"
